...
const LinkrootLogo = ({ className }: { className?: string }) => (
  <div className={cn("flex items-center gap-2", className)}>
    ...
    <span className="text-lg font-semibold tracking-tight font-outfit">Linkroot</span>
  </div>
);
  ...
  return (
    <header
      className={cn(
        ...
        {
          "border-border bg-background/95 backdrop-blur-sm supports-backdrop-filter:bg-background/50 md:max-w-3xl md:shadow":
            scrolled,
        }
      )}
    >
